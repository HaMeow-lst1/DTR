...
if __name__ == "__main__":
    ...
    #   默认指向根目录下的VOC数据集
    #-------------------------------------------------------#
    VOCdevkit_path  = dtr.base_dataset_path + dtr.dataset
    #-------------------------------------------------------#
    #   结果输出的文件夹，默认为map_out
    #-------------------------------------------------------#
    map_out_path    = 'map_out/' + dtr.dataset
    ...
    if map_mode == 0 or map_mode == 1 or map_mode == 4:
        print("Load model.")
    ...
    if map_mode == 0 or map_mode == 2 or map_mode == 4:
